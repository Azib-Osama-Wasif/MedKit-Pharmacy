...
public class NewOrdersFragment extends Fragment {
    ...
    public NewOrdersFragment(Pharmacy pharmacy, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_new_orders_pharmacy, container, false);
        ...
        databaseHandler.getOrdersReference().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot :dataSnapshot.getChildren()) {
                    ...
                    if(order.getPharmacyId().equals(pharmacy.getId()) && order.getStatus().equals(Utilities.order_pending)){
                        orderList.add(order);
                        rowCount++;
