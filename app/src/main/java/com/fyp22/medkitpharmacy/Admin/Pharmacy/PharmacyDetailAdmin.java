...
public class PharmacyDetailAdmin extends AppCompatActivity {
    ...
    PharmacyMedicineAdapterAdmin adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pharmacy_detail_admin);
        ...
        recyclerViewMedicines.setLayoutManager(new GridLayoutManager(PharmacyDetailAdmin.this,2));
    ...
    void updateRecyclerView(){
        ...
        adapter= new PharmacyMedicineAdapterAdmin(PharmacyDetailAdmin.this, medicineList, stockItemList);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(PharmacyDetailAdmin.this,ViewPharmaciesAdmin.class));
        finish();
    }
}